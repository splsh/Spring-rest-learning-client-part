...
public class Communication {
    ...
    private final String URL = "http://localhost:8080/spring_rest_learning_war_exploded/api/employees";
    ...
    public void saveEmployee(Employee employee){
        ...
        if (id==0){
            ...
            System.out.println("New employee was added to db " + responseEntity.getBody());
        }
        else {
